...
function getByID(pbID) {
    $('#KiHieu').css('border-color', 'lightgrey');
    $('#MoTa').css('border-color', 'lightgrey');
    $.ajax({
        url: "/Admin/TinhTrang/GetByID/" + pbID,
        typr: "GET",
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        success: function (result) {
